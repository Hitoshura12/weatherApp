...
var _WeatherApp = __webpack_require__(29);
...
var _superagentJsonp = __webpack_require__(37);
...
function getWeatherData(units, coords) {
  return new Promise(function (resolve, reject) {
    ...
    console.log("test");
    _superagent2.default.get('api.openweathermap.org/data/2.5/weather').query({
      units: parsedUnits,
      lat: coords.lat,
      lon: coords.lon,
      appid: '0494cfc6ef2c1a2cc0eb597988be256e'
    }).use(_superagentJsonp2.default).end(function (error, res) {
      if (error) {
        reject();
